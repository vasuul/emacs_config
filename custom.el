...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (sr-speedbar diminish gnu-elpa-keyring-update rainbow-mode git-gutter magit vlf modern-cpp-font-lock rainbow-delimiters origami auto-package-update nyan-mode esup use-package))))
(custom-set-faces
